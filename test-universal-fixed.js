// Test Universal Name & Phone - Fixed Version
const axios = require('axios');

async function testUniversalFixed() {
  console.log('👤📱 TESTING UNIVERSAL NAME & PHONE - FIXED VERSION\n');

  try {
    const response = await axios.post('http://localhost:3000/api/auth/signup', {
      email: 'fixed@homafoods.com',
      password: 'test123',
